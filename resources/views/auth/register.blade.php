...
<div class="py-28">
    <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
        <img class="hidden lg:block lg:w-1/2 bg-cover" src="{{ url('../storage/Assets/val2.jpg') }}" alt="">
        <div class="w-full p-8 lg:w-1/2">
            <h2 class="text-2xl font-bold text-gray-700 text-center">JAGOMAIN</h2>
            ...
            <div class="mt-4 flex items-center justify-between">
                ...
                <a href="#" class="text-xs text-gray-500 uppercase">or log in</a>
                <span class="border-b w-1/5 md:w-1/4"></span>
            </div>
        </div>
    </div>
